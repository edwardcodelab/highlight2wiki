    function highlightRange(range) {
	    ...
	    var papertitle = url;
           ...
           // document.testform.selectedtext.value += selectedText +"\n";getElementsByName("wikitext")[0]
           if (document.getElementById("edtop").contentWindow.document.getElementsByName("wikitext")[0].value == ""){
           document.getElementById("edtop").contentWindow.document.getElementsByName("wikitext")[0].value += "====== "+papertitle+" ====== \r\n [["+url+"|" + papertitle + "]]  [[?do=highlight2wiki&ur="+url+"|✍Highlight]]--"+timestamp+"\r\n\n";
          document.getElementById("edtop").contentWindow.document.getElementsByName("wikitext")[0].value += "{{tag> }}\r\n\n"; //add tag syntax        		  
                }
		   
           let selectedTextString = document.getElementById("edtop").contentWindow.document.getElementsByName("wikitext")[0].value;
            document.getElementById("edtop").contentWindow.document.getElementsByName("wikitext")[0].value += selectedTextString + selectedText + "\n\n";
        }
    ...
    function markjs(){
            ...
            "diacritics": false}); 
			document.getElementById("edtop").contentWindow.document.getElementsByName("wikitext")[0].value += lines[j] + "\n\n";
   
            }         
        } 

function loadmarkjs(){
var textArea = document.getElementById("edtop").contentWindow.document.getElementsByName("wikitext")[0].value; 
...
function edittag(){
	  ...
	  if(textArea.match(/\{{tag>(.+?)\}}/i)!=null){
	        ...
	        newtextArea = textArea.replace(/\{{tag>(.*)\}}/i,"{{tag>"+textareamatch[1]+" "+ newtagcomponent.toString()+"}}");
	         ...
	         document.getElementById("edtop").contentWindow.document.getElementsByName("wikitext")[0].value = newtextArea;
	        ...
	        console.log("null");
	       document.getElementById("edtop").contentWindow.document.getElementsByName("wikitext")[0].value += "{{tag>" +  newtagcomponent.toString() + "}}\r\n\n";	      
	  }
	}
